...
(function (a) {
    a.fn.featureCarousel = function (f) {
        ...
        var e = function () {
            ...
            var t = a(q.containerIDTag).find(".car-image:first");
        ...
        var b = function () {
            ...
            q.featuresContainer.find(".car-feature").each(function (t) {
                if (t < q.totalFeatureCount) {
                    q.featuresArray[t] = a(this)
                }
            });
            if (q.featuresContainer.find(".car-feature").first().css("borderLeftWidth") != "medium") {
                q.borderWidth = parseInt(q.featuresContainer.find(".car-feature").first().css("borderLeftWidth")) * 2
            }
            q.featuresContainer.find(".car-feature").each(function () {
                a(this).css({
            ...
            }).find(".car-image").css({width: q.smallFeatureWidth});
            if (f.captionBelow) {
                q.featuresContainer.find(".car-caption").css("position", "relative")
            }
            ...
            q.featuresContainer.find(".car-caption").hide()
        };
        var r = function () {
            ...
            if (f.counterStyle == "caption") {
                a.each(q.featuresArray, function () {
                    ...
                    a(this).find(".car-caption p").prepend(x)
                })
            }
        };
        var h = function () {
        ...
        var o = function (y, C) {
            ...
            y.animate({
                ...
                if (x == 1) {
                    ...
                    y.find(".car-caption").fadeTo("fast", 0.85);
                    f.movedToCenter(y)
                }
                ...
                if (f.trackerIndividual || f.trackerSummation) {
                    if (x == 1) {
                        var E = q.featuresContainer.find(".car-feature").index(y) + 1;
                        var F;
                        if (C == false) {
                            F = i(E)
                        } else {
                ...
                p(false)
            }).find(".car-image").animate({width: w, height: t}, f.carouselSpeed, f.animationEasing).end()
        };
        var l = function (w) {
        ...
        q.featuresContainer.find(".car-feature").click(function () {
        ...
        a(".tracker-individual-blip", q.containerIDTag).live("click", function () {
            ...
            var v = q.featuresContainer.find(".car-feature").eq(t - 1).data("position");
    ...
    a.fn.featureCarousel.defaults = {
        ...
        leftButtonTag: "#car-left",
        rightButtonTag: "#car-right",
        captionBelow: false,
